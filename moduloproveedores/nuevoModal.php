...
<?php
  ...
  $formulario->setSelInput("number", "tiprif", "rif", "Rif", "407898280", 12, "required", null, ['V','G','J']);
  $formulario->setInput("text", "tiprifOld", "Tiprif", 12, "V", '', 'hidden');
  $formulario->setInput("number", "rifOld", "Rif", 12, "0000000000", '', 'hidden');
  $formulario->setInput("text", "razon", "Razon social", 12, "Vendedor");
  $formulario->setInput("text", "direccion", "Direccion Fiscal", 12, "5ta Avenida");
