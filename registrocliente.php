...
<?php
  ...
  $formulario->setInput("number", "cedula", "Cedula", 12, "25984693");
  $formulario->setInput("email", "correo", "Correo Electrónico", 12, "pedro@gmail.com");
  $formulario->setInput("number", "telefono", "Telefono", 12, "04165026859");
  $formulario->setInput("password", "password", "Contraseña", 12, "********");
  $formulario->setInput("password", "password2", "Confirmar contraseña", 12, "********");
