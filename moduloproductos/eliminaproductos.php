    ...
    <section class="content">
      <div class="row">
        ...
        <?php while($row_productos = $productos->fetch_assoc()){ ?>
               <tr id="row_<?php echo $row_productos['tprod_idprod']; ?>">
                 ...
                 <a href="#" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#eliminaModal" data-bs-id="<?= $row_productos['tprod_idprod']; ?>"><i class="fa-solid fa-trash"></i> Eliminar</a>
