...
$sql = "SELECT tprod_idprod, tprod_namepr, tprod_descpr, ttpro_idtipp, tpre_idpres, tprod_precic, tprod_preciv, tprod_fechve, tprod_fechin, tprod_cantpr ,tprod_status FROM tprod_tme 
